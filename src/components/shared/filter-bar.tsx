...
export function FilterChips({
  ...
  return (
    <div
      className={cn(
        "inline-flex items-center gap-1 p-1 rounded-xl bg-neutral-900/40 border border-neutral-800/60",
        className,
      )}
    >
      {chips.map((chip) => {
        ...
        return (
          <button
            ...
            className={cn(
              "relative px-3 py-1.5 rounded-lg text-[11px] font-medium transition-all duration-200",
              isActive
